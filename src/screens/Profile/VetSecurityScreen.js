...
export default function VetSecurityScreen({ navigation }) {
  const insets = useSafeAreaInsets();
  const { vetProfile, authUser } = useVetAuth();
      ...
      >
        <View style={styles.accountCard}>
          ...
          <View>
            ...
            <Text style={styles.accountEmail}>{vetProfile?.email || authUser?.email || "—"}</Text>
          </View>
        </View>
